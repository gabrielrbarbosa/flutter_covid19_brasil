...
class PinInformation {
  ...
  PinInformation({this.pinPath, this.icon, this.report, this.locationName, this.labelColor});
}
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Image.asset(widget.currentlySelectedPin.pinPath, width: 50, height: 40),
                    )
                  ),
                  Expanded(
                    child: Container(
